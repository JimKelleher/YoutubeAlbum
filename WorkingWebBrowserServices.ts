...
slideshow.prototype.show_image = function () {
    ...
    // For this time:
    (<HTMLImageElement>document.getElementById("Image")).src = this.images[this.image_index];
...
function get_column_values_as_array(table_id, column_number, has_header) {
    ...
    var html_table_element = (<HTMLTableElement>document.getElementById(table_id));
...
function excise_bounds_inclusive(look_in, start_token, end_token, debug) {
    ...
    } while (cut_start_index > -1 && cut_end_index > -1 && cut_start_index < cut_end_index);
