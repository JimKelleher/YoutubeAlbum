...
const EXAMPLE_LOCATION = "http://r12a.github.io/c";
const EXAMPLE_FILE_EXTENSION = "png";

const BASIC_LATIN   = "Basic_Latin";
const CYRILLIC      = "Cyrillic";
const GENERAL_PUNCT = "General_Punctuation";
const GREEK_COPTIC  = "Greek_and_Coptic";
const LATIN_1_SUP   = "Latin-1_Supplement";
const LATIN_EXTEND  = "Latin_Extended-A";
const MATH_OPERATOR = "Mathematical_Operators";

//----------------------------------------------------------------------------------------------------
// Classes:

class UnicodeAsciiDetail {
    language: string;
    unicodeHex: string;
    description: string;
    ASCII: string;
...
class unicode_ASCII {
    ...
    unicode_ASCII_array: UnicodeAsciiDetail[] = [];
    ...
    add_unicode_ASCII(language: string, unicode_hex: string, description: string, ASCII: string) {

        let unicodeAsciiDetail: UnicodeAsciiDetail = {language: language, unicodeHex: unicode_hex, description: description, ASCII: ASCII}
    ...
    get_ASCII(unicode_hex) {

        let ASCII: string = ""; // init

        // Search the object array for the desired unicode hex value:
        for (let i: number = 0; i < this.unicode_ASCII_array.length; i++) {
